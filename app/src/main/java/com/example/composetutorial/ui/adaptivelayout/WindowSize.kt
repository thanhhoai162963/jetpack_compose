package com.example.composetutorial.ui.adaptivelayout
...
fun Activity.rememberWindowSizeClass(): WindowSize {
    ...
    val windowMetrics = remember(configuration) {
        WindowMetricsCalculator.getOrCreate().computeCurrentWindowMetrics(activity = this)
    }
    ...
    return WindowSize(
        ...
        }, widthWindowDpSize = windowDpSize.width, heightWindowDpSize = windowDpSize.height
    )
}